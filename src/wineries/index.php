...
<body>
	<div class='map' id='fade'>
		<iframe width='100%' height='100%' frameborder='0' style='border:0' src='<?=$mapembedurl?>'>
		</iframe></div>
	...
	<div class='outer'>
		<div class='middle'>
			<div class='inner'>
				...
				<a href='http://maps.google.com/?q=<?=$fulladdress?>%20<?=$municipality?>%20Ontario' target='_blank'>
					<p><i class='fa fa-map-marker' aria-hidden='true'></i> <?=$fulladdress?></p>
				</a>
			</div>
	...
	<div class='footer'>
		<div class='footerinner'>
			<p>Designed by <a href='https://ryderdamen.com'>Ryder Damen</a> | Powered by <a href='https://niagaraopendata.ca'>Niagara
					Open Data</a> | <a href='https://www.behance.net/gallery/49669467/WineNiagara-Open-Data-Day-2017'>How It
					Works</a>
			</p>
		</div>
	</div>
